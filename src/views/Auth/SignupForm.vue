...
<template>
  ...
  >
    <v-card class="w-full max-w-md rounded-2xl shadow-xl text-center">
      <div class="p-6 sm:p-8">
        ...
        <!-- Title -->
        <h2 class="text-lg sm:text-xl font-semibold text-gray-800 mb-1">Create Account</h2>
        ...
        >
          <div :key="authMode">
            ...
            <div v-else class="space-y-4">
              ...
              <v-btn block size="large" rounded="lg" color="#0B1F3A" class="text-white">
                Log In
              </v-btn>
